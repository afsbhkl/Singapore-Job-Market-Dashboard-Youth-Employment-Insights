...
本项目通过 Streamlit 构建的交互式仪表板，分析了新加坡 **2007–2024 年的就业、薪资、教育与失业趋势**，旨在帮助 **25–29 岁青年** 发掘最具潜力的行业与职业方向。
...
* 👩‍💼 **Youth Share by Industry (2024)** — discover which industries attract more young workers.
* 🏭 **Main vs Service Sub-sectors** — compare manufacturing, construction, and service sector performance.
...
* 👩‍💼 **行业青年占比（2024）** — 探索哪些行业更吸引年轻人。
* 🏭 **主行业与服务业细分对比** — 对比制造业、建筑业与服务业的表现。
...
### 2️⃣ Occupation Perspective / 职业视角
...
### 3️⃣ Education Perspective / 教育视角
...
### 4️⃣ Strategic Insights for Youth / 对青年人的启示
...
**Institution:** Nanyang Business School, Nanyang Technological University (NTU), Singapore
**Team:** Liu Chang · Xu Anlan · Yao Ruwei · Yu Yining · Tang Yiwei · Chu Tian

---

## 💬 Citation

Comprehensive Salary & Employment Dashboard (2025).
SG Job Market Research Presentation (2025).
Nanyang Technological University, Singapore.

---

是否希望我帮你继续生成一个可直接上传到 GitHub 的 **README.md 文件（含所有 Markdown 换行符与 emoji 样式）**？
这样你可以直接复制粘贴整个文件到仓库根目录，无需再手动调整格式。
